...
1. Please refer the [QUICK INSTALLATION](../../End_2_End/PGNet/PaddleOCR-release-2.1/doc/doc_en/installation_en.md) to install PaddlePaddle. Python3 environment is strongly recommended.
