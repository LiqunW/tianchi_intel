...
def run_demo():
    ...
    parser.add_argument('--image_folder', required=True, type=str, #r'/mnt/jyyu/data/ocr/xg_ctc_/test',
    ...
    parser.add_argument('--character',type=str,
                        default=load_characters("char_list.txt"),help='character label') # 载入中文字符集
