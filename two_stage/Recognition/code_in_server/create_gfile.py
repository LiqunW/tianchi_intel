...
if __name__ == "__main__":
    #data_path = {'image': [r'/mnt/jyyu/data/ocr/data_gen_100w_1/img',
    #                       r'/mnt/jyyu/data/ocr/data_gen_200w_1/img',
    # 
    #],
    #             'label': [r'/mnt/jyyu/data/ocr/data_gen_100w_1/txt',
    #                       r'/mnt/jyyu/data/ocr/data_gen_200w_1/txt',
    #             ]
    #}
    data_path = {'image':[r'/mnt/jyyu/data/ocr/xg_ctc/train/JPEGImages'],
                 'label':[r'/mnt/jyyu/data/ocr/xg_ctc/train/TXT']
    }
    imgs, labels = load_img_label(**data_path)
    process_data(imgs, labels, out_dir=r'./test_gt.txt')
