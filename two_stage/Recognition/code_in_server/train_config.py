...
parser.add_argument('--train_data', type=str, default=r'/mnt/jyyu/data/dataset',
                    help='path to training dataset')
parser.add_argument('--valid_data', type=str,default=r'/mnt/jyyu/data/dataset/test',
                    help='path to validation dataset')

# 多个真实数据比例，使用单个数据集，--select_data='/', --batch_ratio='1'
parser.add_argument('--select_data', type=str, default='train_gen-train',
